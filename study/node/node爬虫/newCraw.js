...
var i = 0;
var url = "https://music.163.com/#/discover/playlist/?order=hot&cat=%E8%AF%B4%E5%94%B1&limit=35&offset=0";
//初始url 
...
function startRequest(x) {
    ...
    http.get(x, function (res) { //get到x网址，成功执行回调函数
        ...
        res.on('end', function () {
            ...
            console.log($('#m-disc-pl-c').html());

            
            // var news_item = {
            //     //获取电影的标题
            //     title: $('#m-pl-container li .dec').text().trim(),
            //     //i是用来判断获取页数
            //     i: i = i + 1,
...
function savedContent($, news_title) {
    console.log($('#m-pl-container').html());
    
    // $('#m-pl-container .dec a').each(function (index, item) {
    //     var x = $(this).text()
    //     console.log(x);
